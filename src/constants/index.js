...
export const HERO_CONTENT = `I am a passionate Data Engineer with expertise in AI and ML, dedicated to leveraging Big Data technologies to deliver impactful solutions. With a year of experience, I specialize in automating ETL workflows and optimizing data pipelines using tools like SSIS, Snowflake, and Azure Data Factory. Proficient in Python and SQL, I tackle complex data challenges with PySpark and Databricks while ensuring seamless software delivery with CI/CD pipelines and Docker. I harness Azure services like Cosmos DB and Azure Data Lake to architect scalable solutions. My commitment to innovation drives me to excel in data engineering and cloud architecture.`;

export const ABOUT_TEXT = `I am an enthusiastic full-stack developer and dedicated Data Engineer with 2 years of experience, committed to leveraging Big Data technologies across various cloud platforms. My curiosity about data's potential drives me to solve complex problems and create impactful solutions. I specialize in front-end technologies like React and back-end solutions using Node.js, MySQL, and PostgreSQL, ensuring seamless software delivery. I focus on automating ETL workflows and delivering actionable insights. My experience with Azure services enables me to architect scalable solutions that foster innovation. My journey in tech is fueled by a fascination with how things work, and I thrive in collaborative environments, demonstrating leadership qualities while delivering high-quality results. Outside of my professional pursuits, I'm a football enthusiast, a former school team captain, and an avid foodie who enjoys exploring new cuisines.`;
